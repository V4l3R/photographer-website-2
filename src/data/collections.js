...
let COLLECTIONS = [
 ...
 // },
 {
  ...
  collection: importAll(
   require.context('../img/collections/default/', false, /\.(png|jpe?g|svg)$/),
  ),
 },
 {
  name: 'Printemps',
 ...
 },
 {
  ...
  collection: importAll(
   require.context(
    '../img/collections/vacances italie/',
    false,
    /\.(png|jpe?g|svg)$/,
   ),
  ),
 },
 {
  ...
  collection: importAll(
   require.context('../img/collections/kitties/', false, /\.(png|jpe?g|svg)$/),
  ),
 },
 {
  name: 'Test',
  ...
  collection: importAll(
   require.context('../img/collections/test/', false, /\.(png|jpe?g|svg)$/),
  ),
 },
];
