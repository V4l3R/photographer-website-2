            ...
            <div
             ...
             className={`${
              currentCollection === ''
               ? 'opacity-50'
               : 'opacity-100 cursor-pointer'
             } ${isOpenAlbRenamePopup ? 'border-b-2 border-black' : ''}`}
            >
             <FaPenNib />
            </div>
            <div
             ...
             className={`${
              currentCollection === ''
               ? 'opacity-50'
               : 'opacity-100 cursor-pointer'
             } ${isOpenPicAddPopup ? 'border-b-2 border-black' : ''}`}
            >
             <MdAddPhotoAlternate />
            </div>
            <div
             ...
             className={`${
              listSelectedImg.length !== 1
               ? 'opacity-50'
               : 'opacity-100 cursor-pointer'
             } ${isOpenPicRenamePopup ? 'border-b-2 border-black' : ''}`}
            >
             <RiImageEditFill />
            </div>
            <div
             ...
             className={`${
              listSelectedImg.length < 1
               ? 'opacity-50'
               : 'opacity-100 cursor-pointer'
             } ${isOpenPicDeletePopup ? 'border-b-2 border-black' : ''}`}
            >
             <BsFillTrashFill />
            </div>
            <div
             ...
             className={`${
              currentCollection === ''
               ? 'opacity-50'
               : 'opacity-100 cursor-pointer'
             } ${isOpenAlbDeletePopup ? 'border-b-2 border-black' : ''}`}
            >
             <GiChewedSkull />
            </div>
           </div>
