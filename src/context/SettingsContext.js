...
const mouseEnterHandler = () => {
  ...
  return (
    <SettingsContext.Provider value={{ galleryImageHeight, gallerySpacing, facebookUrl, twitterUrl, instagramUrl, pinterestUrl, youtubeUrl, getSettingsContext, settings, setSettings }}>
      {children}
